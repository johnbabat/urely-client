    ...
    <>
        <div className="m-2 mt-6 md:m-10 p-2 md:p-10 bg-white rounded-3xl">
            ...
            <div className="relative mt-6">
                ...
                <input type="search" id="default-search" className="block p-2 pl-10 w-full max-w-lg text-sm text-gray-900 bg-gray-50 rounded-lg border border-gray-300 focus:border-blue-500" placeholder="Search documents... " required />
            </div>
            ...
            { 
                mydocuments && mydocuments.map(document => (
                    <div className="p-6 max-w-sm rounded-lg col-span-12 sm:col-span-6 lg:col-span-4 xl:col-span-3 border border-gray-200 shadow-md bg-gray-600">
                        ...
                        <p className="mb-3 font-normal text-gray-400">{ document.text.length > 30 ? document.text.slice(0,70) + "..." : document.text }</p>
