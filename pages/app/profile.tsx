    ...
    <>
        ...
        <div className="">
            <div className="flex flex-col gap-4 items-center text-center mt-12 pb-6">
                ...
                />
                <div>
                <p className="font-semibold text-2xl text-gray-600 font-mono">{user.firsName.length > 15 ? user.firsName[0] + '.':user.firsName} {user.lastName.length > 15 ? user.lastName[0] + '.':user.lastName} </p>
            ...
            <form className='m-auto max-w-lg mb-9 p-3'>
                <div className="relative z-0 w-full mb-6 group">
                    <input type="email" name="floating_email" className="block py-2.5 px-0 w-full text-sm text-gray-900 bg-transparent border-0 border-b-2 border-gray-300 appearance-none dark:border-gray-600 dark:focus:border-blue-500 focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder=" " required />
